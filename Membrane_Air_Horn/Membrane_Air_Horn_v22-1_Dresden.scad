...
DesignStatus="printing_CAN"; // ["sizing","fitting","printing_CAN","printing_COVER", "textfitting", "Only_Text"]
...
////Message: 2
STRINGOFTEXT_Cover="Dresden 25.05.2023";  // (11 charackters)
...
if (DesignStatus=="printing_CAN"){ //BlowCanHeight+MembraneCoverHeight-ClampLipOverlap
    translate([0,0,0]){
        Blow_Can();
    }
}
if (DesignStatus=="printing_COVER"){ //BlowCanHeight+MembraneCoverHeight-ClampLipOverlap
