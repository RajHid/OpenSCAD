...
//FONTWIDTHSTRING_Cover=[ 0.00,2.85,2.20,1.10,1.10,2.00,1.55,3.60,2.20,1.10];

// sizing printing or print a small part to test the  fitting???

//DesignStatus="textfitting";

DesignStatus="printing"; // ["sizing","fitting","printing", "textfitting"]
//String_Print="yes";
...
//STRINGOFTEXT_BlowCan="Riders"; // (32 charackters)
//FONTWIDTHSTRING_BlowCan=[0.00,2.80,1.98,2.12,2.14,2.02];
//
//
////Message: 2
//STRINGOFTEXT_Cover="Streik 2023";  // (11 charackters)
//FONTWIDTHSTRING_Cover=[0.00,2.50,1.98,1.83,1.92,1.76,1.50,2.50,2.20,2.20,1.10,2.20];


// ================== Köln 28.04.2023

STRINGOFTEXT_BlowCan="Riders unite, together we fight!"; // (32 charackters)
FONTWIDTHSTRING_BlowCan=[0.00,2.50,0.75,2.05,1.85,1.20,0.75,1.80,2.05,2.07,0.75,0.95,1.85,0.75,0.73,0.97,2.05,2.05,1.85,0.95,2.07,1.85,0.75,1.17,2.72,0.75,1.83,0.97,0.72,2.07,2.07,0.95];

////Message: 2
STRINGOFTEXT_Cover="1.Mai 2023";  // (11 charackters)
FONTWIDTHSTRING_Cover=[0.00,1.85,0.75,2.95,1.80,0.75,0.72,1.85,1.85,1.85];


//////Message: 2
//STRINGOFTEXT_Cover="Köln 28.04.2023";  // (11 charackters)
//FONTWIDTHSTRING_Cover=[0.00,2.50,2.05,0.75,1.10,1.70,1.85,1.85,0.72,1.85,1.85,0.72,1.85,1.85,1.85];
// ================== Köln 28.04.2023 ================== \\

//STRINGOFTEXT_BlowCan="Riders unite, together we fight!"; // (32 charackters)
//FONTWIDTHSTRING_BlowCan=[ 0.00,2.86,1.10,2.40,2.20,1.55,1.55,1.75,2.40,2.40,1.10,1.35,2.20,1.00,1.20,1.30,2.40,2.40,2.20,1.35,2.40,2.20,1.50,1.15,3.05,1.10,2.20,1.30,1.10,2.45,2.40,1.30];
//
//
////Message: 2
//STRINGOFTEXT_Cover="Streik 2023";  // (11 charackters)
//FONTWIDTHSTRING_Cover=[ 0.00,2.85,2.20,1.55,1.10,1.10,1.50,2.00,2.20,2.20,1.10,2.20,2.20,1.10,2.20,2.20,2.20];

// STRINGOFTEXT_Cover="Berlin 28.02.2023";  // (11 charackters)
// FONTWIDTHSTRING_Cover=[ 0.00,2.85,2.20,1.55,1.10,1.10,1.50,2.00,2.20,2.20,1.10,2.20,2.20,1.10,2.20,2.20,2.20];
...
// FONTWIDTHSTRING_Cover=[ 0.000,2.375,2.375,2.375,2.375,2.375,2.375,2.375,2.375,2.375,2.375,2.375,2.375,2.375,2.375,2.375,2.375,2.375];


//Message: 2
//STRINGOFTEXT="Hello World";  // (11 charackters)
//FONTWIDTHSTRING_Cover=[ 0.000,2.375,2.375,2.375,2.375,2.375,2.375,2.375,2.375,2.375,2.375];
...
// Message: 1
//STRINGOFTEXT="www.printables.com";  // (18 charackters)
//FONTWIDTHSTRING_Cover=[ 0.00,3.30,3.30,3.25,1.10,2.70,1.20,0.75,2.45,1.30,2.70,2.70,0.80,2.60,1.50,1.10,2.55,2.60];

//Message: 2
//STRINGOFTEXT="Hello World";  // (11 charackters)
//FONTWIDTHSTRING_Cover=[ 0.00,2.70,2.55,0.80,0.80,1.0,2.70,3.80,2.55,1.20,0.80];
...
// Message: 1
//STRINGOFTEXT="www.printables.com";  // (18 charackters)
//FONTWIDTHSTRING_Cover=[ 0.00,2.85,2.85,2.65,1.10,2.20,1.30,0.90,2.20,1.10,2.20,2.20,0.85,2.20,2.00,1.10,1.95,2.20];

//Message: 2
//STRINGOFTEXT="Hello World";  // (11 charackters)
//FONTWIDTHSTRING_Cover=[ 0.00,2.85,2.20,0.90,0.85,0.55,2.75,3.65,2.20,1.30,0.0];
...
module CYLINDER_EMBOSSER(   STRINGOFTEXT_EMBOSS,
    ...
    FooBaa=[for (a = [ 0 : len(FONTWIDTHSTRING_String) - 1 ]) (FONTWIDTHSTRING_String[a]*180*ONEPointMM)*FONTSIZE/(PI*DIAMETER/2) ];
    function cumsum(v) = [
        for (   a = v[0]-v[0], i = 0; i < len(v); a = a+v[i], i = i+1) a+v[i]]; // Some fancy Vector Foo i obviously copy pastet from somewere
    Vector_Chooser=cumsum(FooBaa);
    intersection(){
        ...
        translate([0,0,0]){
            for(i=[0:len(STRINGOFTEXT_EMBOSS)-1]){
                rotate([0,0,Vector_Chooser[i]+Vector_Chooser[i]*0.05]){
