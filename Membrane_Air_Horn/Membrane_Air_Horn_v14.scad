...
//TEXTSTRING(STRINGOFTEXT2,Vector);
TEXTSTRING(STRINGOFTEXT2,Vector_BlowCan);
// TEST_Cylinder();
...
STRINGOFTEXT="Riders unite, together we fight!"; // (32 charackters)
FONTWIDTHSTRING_2=[ 0.00,2.86,1.10,2.40,2.20,1.55,1.55,1.75,2.40,2.40,1.10,1.35,2.20,1.00,1.20,1.30,2.40,2.40,2.20,1.35,2.40,2.20,1.50,1.15,3.05,1.10,2.20,1.30,1.10,2.45,2.40,1.30];


//Message: 2
STRINGOFTEXT2="Berlin 28.02.2023";  // (11 charackters)
FONTWIDTHSTRING_3=[ 0.00,2.85,2.20,1.55,1.10,1.10,1.50,2.00,2.20,2.20,1.10,2.20,2.20,1.10,2.20,2.20,2.20];
...
//CYLINDER_EMBOSSER(DIAMETER,FONTSIZE,WALLTHICKNESS,Vector);
module CYLINDER_EMBOSSER(STRINGOFTEXT,OUTER_D,FONTSIZE,EMBOSSDEPTH,ROT_Tune,Vector,Spiral_Ascnd_Step=1,Spiral_Ascnd_Deg=10){
    intersection(){
