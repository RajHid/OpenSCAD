...
FONTWIDTHSTRING_BlowCan=[ 0.00,2.85,1.98,2.12,2.14,2.02];


//Message: 2
STRINGOFTEXT_Cover="Streik 2023";  // (11 charackters)
FONTWIDTHSTRING_Cover=[ 0.00,2.64,1.98,1.83,1.92,1.76,1.50,2.50,2.20,2.20,1.10,2.20];
...
module TEXTSTRING(STRINGOFTEXT,VECTOR){
    ...
    echo("VECTOR",VECTOR[i]);
        translate([i*VECTOR[i]*ONEPointMM*FONTSIZE,0,2]){
            color("Fuchsia",0.5){
                linear_extrude(height=EMBOSSDEPTH){
